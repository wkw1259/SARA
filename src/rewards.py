...
# sys.path.append("/home/weikaiwen/self-critical.pytorch")
sys.path.append("/home/weikaiwen/self-critical.pytorch/scripts")
...
def get_self_critical_reward(greedy_res, data_gts, gen_result, rouge_reward_weight=1.0):
    ...
    evaluator = Evaluator()
    result_dict = evaluator.evaluate(res__, gts_, None, metrics=["rouge"])
    ...
    scores = rouge_reward_weight * cider_scores + bleu_reward_weight * bleu_scores
