...
class GenerationMixin:
    ...
    def generate(
        ...
        **kwargs,
        ...
        presumm_inputs_model_kwargs={"input_ids": presumm_input}
    ...
    def sample(
        ...
        **model_kwargs,
        ...
        while True:
            ...
            presumm_model_inputs = self.prepare_inputs_for_generation(presum_input_ids,**presumm_inputs_model_kwargs) if context_aware_decoding_alpha > 0. and cad_full<1. and cad_salience>0. and cad_full+cad_salience==1. else None
            ...
            if context_aware_decoding_alpha > 0.:
                ...
                null_next_token_logits = null_outputs.logits[:, -1, :]
                if cad_full<1. and cad_salience>0. and cad_full+cad_salience==1.:
                  ...
                  if synced_gpus and this_peer_finished:
                    continue  # don't waste resources running the code we don't need
                  next_token_logits = (1+context_aware_decoding_alpha)*(next_token_logits)-context_aware_decoding_alpha*null_next_token_logits
            # pre-process distribution
    ...
    def beam_search(
        ...
        **model_kwargs,
        ...
        while True:
            ...
            model_inputs = self.prepare_inputs_for_generation(input_ids, **model_kwargs)
            null_model_inputs = self.prepare_inputs_for_generation(null_input_ids, **null_inputs_model_kwargs) if context_aware_decoding_alpha > 0. else None
            presumm_model_inputs = self.prepare_inputs_for_generation(presum_input_ids,**presumm_inputs_model_kwargs) if context_aware_decoding_alpha > 0. else None
            outputs = self(
                **model_inputs,
                return_dict=True,
                output_attentions=output_attentions,
